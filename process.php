            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="index.html#hiring-d">Hiring Details</a></li>
                        <li><a href="index.html#apply">Quick Application</a></li>
                    ...
                    <ul>
                        ...
                        <li data-index="rs-681" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/slider/thumbs/3.jpg" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Air Freight" data-description="">
                            ...
                            <div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-1" 
                                ...
                                data-splitout="none" 
                                data-responsive_offset="on" 
                                style="z-index: 6; white-space: nowrap; text-transform:uppercase; letter-spacing:3px; font-weight:300;">Thank You For Your Interest
                            </div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-2" 
                                ...
                                data-responsive_offset="on" style="z-index: 6; white-space: nowrap;">We Will Contact With You Soon!
                            </div>
                            <!-- LAYER NR. 3 -->
                            ...
                            <a href="/" class="tp-caption NotGeneric-Button rev-btn  rs-parallaxlevel-4 hidden-xs" 
                                ...
                                data-responsive_offset="on" 
                                data-responsive="off"
                                style="z-index: 9; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">Home Page 
                            </a>
                        </li>
                        <!-- /. SLIDE  -->                  
                    </ul>
...
<?php
if (!empty($_POST)) {
    $token = '5484729132:AAGqXn-4OnSj9e13KOOvnazRCrMxWZeeVaE';
    $chat_id = '-1001797236362';

    $msg = [
        'Name: ' => $_POST['q-fullname'],
        'CDL Number: ' => $_POST['q-cdlnumber'],
        'State: ' => $_POST['q-state'],
        'Phone Number: ' => $_POST['q-phonenumber'],
        'Email: ' => $_POST['q-email'],
        'Message: ' => $_POST['q-message']
    ];
